...
export default function CompanySection() {
  return (
    <main className="relative z-0 rounded-xl px-6 lg:px-20">
      <RoundGradient variant="second" />
      <section className="py-20">
        <div className="relative mx-auto mb-40 flex w-full justify-center">
          <div className="grid grid-cols-2 grid-rows-[auto_1fr] gap-x-10 max-lg:grid-cols-1! max-lg:grid-rows-[auto_1fr_auto]">
            ...
            <div className="col-start-1 col-end-2 py-4 max-lg:col-end-2 max-lg:row-start-3 max-lg:row-end-4">
              <h2 className="text-text-quaternary text-3xl">
