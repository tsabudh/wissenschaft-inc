...
import { gcpArticles } from "@/data/articles"; // define similar to pythonArticles
      ...
      <section className="mb-24 text-center">
        ...
        <div className="mx-auto max-w-4xl space-y-6 text-gray-600">
          <p>
            ...
            sustainability. It&apos;s designed to power modern, distributed systems while keeping cost
            and performance in balance.
          </p>
          <p>
            Whether we&apos;re running data pipelines, deploying microservices, or leveraging BigQuery
            for analytics, GCP&apos;s ecosystem allows our team to build faster, scale smarter, and
            maintain reliability across global workloads.
          </p>
        </div>
      </section>
