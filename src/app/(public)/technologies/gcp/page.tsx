    ...
    <main className="text-text-primary mx-auto min-h-screen max-w-7xl px-6 py-16 lg:px-20">
      ...
      <section className="mb-24 text-center">
        <h2 className="text-heading-secondary mb-10 text-3xl font-bold">
          Tools and Services We Use on GCP
        </h2>
      ...
      {/* 📰 BLOG / ARTICLES */}
      {gcpArticles.length > 0 && (
        <section className="mb-24 text-center">
          <h2 className="text-heading-secondary mb-10 text-3xl font-bold">
            Insights from Our Cloud Team
          </h2>
          <p className="text-text-tertiary mx-auto mb-10 max-w-2xl">
            Articles and case studies from our engineers — covering GCP architecture, DevOps, and
      ...
      {/* 🚀 CTA */}
      <section className="text-foreground mb-24 rounded-xl bg-green-700 px-4 py-16 text-center">
