  ...
  return (
    <main className="text-text-primary mx-auto flex min-h-screen max-w-7xl flex-col gap-12 px-6 py-16 lg:px-20 dark:text-gray-300">
      ...
      <section id="services">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <article className="bg-surface-secondary rounded-xl p-6 shadow-md transition hover:shadow-xl">
            ...
            <p className="text-md text-text-tertiary mb-3">
      ...
      <section id="stack">
        ...
        <p className="text-md text-text-quaternary mt-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="bg-surface-secondary rounded-xl p-8 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="text-text-quaternary flex h-10 w-48 items-center justify-center rounded-md border border-gray-100 bg-gray-50 text-sm">
                Direct Contact Medical
              </div>
              <div className="text-text-quaternary flex h-10 w-28 items-center justify-center rounded-md border border-gray-100 bg-gray-50 text-sm">
                SK
              </div>
            </div>
          </div>
      ...
      <section id="case-studies">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <article className="bg-surface-secondary rounded-lg p-4 shadow-sm">
            <div className="bg-surface-tertiary mb-3 h-36 w-full overflow-hidden rounded-md">
            ...
            <p className="text-md text-text-quaternary mb-3">
