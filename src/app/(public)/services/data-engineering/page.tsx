...
import dataEngineeringPageData from "@/data/data-engineering-page.json";

// filepath: e:\wissenschaft-next\src\app\(public)\services\data-engineering\page.tsx

export const metadata: Metadata = metadataMap["/services/data-engineering"];

export default function DataEngineeringPage() {
    const { hero, whoWeBuildFor, coreServices, process, technologyStack, whyChooseUs, cta } =
        dataEngineeringPageData.page ? dataEngineeringPageData : dataEngineeringPageData;
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="bg-surface-secondary rounded-xl p-8 shadow-sm">
                        ...
                        <p className="text-md text-text-tertiary mb-4">
                            From healthcare data integration to financial transaction processing and beyond.
                        </p>
