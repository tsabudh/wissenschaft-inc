...
import dataAnalyticsPageData from "@/data/page-data-analytics.json";

export const metadata: Metadata = metadataMap["/services/data-analytics"];

export default function DataAnalyticsPage() {
  const { hero, whoWeBuildFor, coreServices, process, technologyStack, whyChooseUs, cta } =
    dataAnalyticsPageData.page ? dataAnalyticsPageData : dataAnalyticsPageData;
  ...
  return (
    <main className="text-text-primary mx-auto flex min-h-screen max-w-7xl flex-col gap-12 px-6 py-16 lg:px-20 dark:text-gray-300">
      ...
      <section className="mb-20 text-center">
        ...
        <p className="text-text-tertiary mx-auto max-w-3xl text-lg md:text-xl">{hero.subheading}</p>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="bg-surface-secondary rounded-xl p-8 shadow-sm">
            ...
            <p className="text-md text-text-tertiary mb-4">
              From healthcare analytics to financial insights and beyond.
            </p>
