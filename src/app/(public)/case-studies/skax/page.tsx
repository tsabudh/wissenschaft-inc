    ...
    <main className="min-h-screen px-6 py-12 text-gray-800 md:px-12 lg:px-24 dark:text-gray-300">
      <div className="mx-auto max-w-7xl">
            ...
            <div>
              <FadeIn>
                ...
                <div className="mt-6 flex gap-3">
                  <Link
                    href="#results"
                    className="text-foreground inline-flex items-center justify-center rounded-lg bg-slate-900 px-5 py-2 text-sm font-medium shadow"
                  >
                    View results
                  </Link>
                  <Link
            ...
            <div className="rounded-2xl border border-slate-100 p-8 shadow-sm">
              ...
              <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div className="bg-background rounded-xl border border-slate-100 p-5 shadow-sm">
                  <p className="text-3xl font-s emibold">90%</p>
        ...
        <section id="contact" className="mb-12">
          <div className="text-foreground rounded-2xl bg-slate-900 p-8 shadow-lg">
            <div className="max-w-3xl">
              <h3 className="text-2xl font-semibold text-gray-300 dark:text-gray-600">Want a website like this?</h3>
              <p className="mt-3 text-slate-600">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="text-white inline-block rounded-lg border border-white/30 px-5 py-2 text-sm"
                >
                  Request a demo
                </Link>
              </div>
