  ...
  return (
    <main className="min-h-screen  px-6 py-16">
      ...
      <section className="mb-16 px-6 text-center">
        <h1 className="mb-4 text-4xl font-bold text-gray-800 dark:text-gray-300 md:text-5xl">Meet the Team</h1>
      ...
      <section className="bg-background mt-24 py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="mb-6 text-3xl font-semibold text-gray-800 dark:text-gray-300">Our Culture</h2>
      ...
      {/* CTA Section */}
      <section className="text-foreground mt-20 bg-indigo-600 py-16 text-center rounded-2xl">
